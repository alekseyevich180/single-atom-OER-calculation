...
SCATTER_MARKER = 'o'
# use a smaller hollow-Nicle marker
SCATTER_SIZE = 10
SCATTER_EDGE_COLOR = '#1b9e77'   # palette blue
...
TITLE_MAIN = "O-Ni-O Angle vs -IpCOHP"
...
SAVE_DIR = 'Ni_Results'           # 图像保存的文件夹名称
