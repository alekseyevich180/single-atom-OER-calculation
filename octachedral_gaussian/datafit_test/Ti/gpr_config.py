...
SCATTER_SIZE = 10
SCATTER_EDGE_COLOR = '#5ec6ce'   # palette blue
...
TITLE_MAIN = "O-Ti-O Angle vs -IpCOHP"
...
SAVE_DIR = 'Ti_Results'           # 图像保存的文件夹名称
