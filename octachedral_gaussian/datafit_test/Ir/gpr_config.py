...
SCATTER_SIZE = 10
SCATTER_EDGE_COLOR = '#d9675c'   # palette blue
...
TITLE_MAIN = "O-Ir-O Angle vs -IpCOHP"
...
SAVE_DIR = 'Ir_Results'           # 图像保存的文件夹名称
