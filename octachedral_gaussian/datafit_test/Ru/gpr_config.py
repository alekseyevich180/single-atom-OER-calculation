...
SCATTER_MARKER = 'o'
# use a smaller hollow-Rucle marker
SCATTER_SIZE = 10
SCATTER_EDGE_COLOR = '#75c267'   # palette blue
...
TITLE_MAIN = "O-Ru-O Angle vs -IpCOHP"
...
LEGEND_TREND_LABEL = "Ru GPR Trend"
# Human-readable plot name (e.g., for saving, captions)
PLOT_NAME = "O-Ru-O Angle vs -IpCOHP (GPR Trend)"
